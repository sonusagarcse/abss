<?php
// teacher/print_invoice.php - Detailed Teacher Fee/Payout Invoice View for Teachers
...
// Fetch invoice details and ensure it belongs to the logged-in teacher
$stmt = $conn->prepare("
...
");
$stmt->bind_param("ii", $invoice_id, $teacher_id);
$stmt->execute();
$invoice = $stmt->get_result()->fetch_assoc();

if (!$invoice) {
    die("<div style='font-family:sans-serif; text-align:center; padding:50px;'><h2>Access Denied</h2><p>Invoice not found or unauthorized access.</p><a href='invoices.php'>Back to Invoices</a></div>");
}
...
<body>
    ...
    <div class="control-bar">
        <div style="display:flex; gap: 10px;">
            <a href="invoices.php" class="btn-control btn-back"><i class="fas fa-chevron-left"></i> Back to Invoices</a>
